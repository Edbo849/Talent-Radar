...
/**
 * Entity representing injury records for players. Tracks injury details
 * including type, severity, dates, and recovery status. Used for monitoring
 * player fitness and availability for selection.
 */
@Entity
