...
/**
 * Entity representing detailed scouting reports for players. Contains
 * comprehensive player evaluations including technical, physical, and mental
 * assessments with ratings, observations, and recommendations created by scouts
...
public class ScoutingReport {
    ...
    public void validateRatings() {
        if (overallRating != null && technicalRating != null
                && physicalRating != null && mentalRating != null) {

            int averageRating = (technicalRating + physicalRating + mentalRating) / 3;
            if (Math.abs(overallRating - averageRating) > 2) {
                throw new IllegalArgumentException(
                        "Overall rating should be within 2 points of the average of other ratings");
            }
        }
    }
